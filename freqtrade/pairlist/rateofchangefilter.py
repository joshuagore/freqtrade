...
class RateOfChangeFilter(IPairList):
    ...
    def __init__(self, exchange, pairlistmanager,
        ...
        if self._days < 1:
            raise OperationalException("RateOfChangeFilter requires lookback_days to be >= 1")
        if self._days > exchange.ohlcv_candle_limit:
            raise OperationalException("RateOfChangeFilter requires lookback_days to not "
